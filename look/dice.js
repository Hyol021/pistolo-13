...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-2647db90');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-2647db90');}
...
function clearFlash(){dieView.classList.remove('rl-win-2647db90');dieView.classList.remove('rl-lose-2647db90');if(frameEl){frameEl.classList.remove('rl-win-2647db90');frameEl.classList.remove('rl-lose-2647db90');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-2647db90');if(frameEl){frameEl.classList.add('rl-win-2647db90');}}else{dieView.classList.add('rl-lose-2647db90');if(frameEl){frameEl.classList.add('rl-lose-2647db90');}}
...
var brandEl=document.querySelector('.rl-brand-2647db90');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
